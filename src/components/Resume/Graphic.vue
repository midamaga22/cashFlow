...
<script setup>
import {ref, toRefs, defineProps, defineEmits, computed, warn, watch } from 'vue';
...
const tap = ({target, touches}) =>{
    ...
    const elemntX = target.getBoundingClientRect().x;
    const touchx = touches[0].clientX;
    pointer.value = ((touchx - elemntX) * 300) / elementWidth;
